		...
		if ((entity.getDisplayName().getString()).equals("clippedbyengie")) {
			{
				...
				if (!_ent.level.isClientSide() && _ent.getServer() != null)
					_ent.getServer().getCommands().performCommand(_ent.createCommandSourceStack().withSuppressedOutput().withPermission(4), "execute if entity clippedbyengie run gamemode spectator");
			}
